...
ifeq ($(FLEXGUARD_NEXT_WAITER_DETECTION),1)
	DEFINED += -DFLEXGUARD_NEXT_WAITER_DETECTION=1
else ifeq ($(FLEXGUARD_NEXT_WAITER_DETECTION),2)
	DEFINED += -DFLEXGUARD_NEXT_WAITER_DETECTION=2
endif

ifeq ($(FLEXGUARD_LOCAL_PREEMPTIONS),1)
	DEFINED += -DFLEXGUARD_LOCAL_PREEMPTIONS
endif
