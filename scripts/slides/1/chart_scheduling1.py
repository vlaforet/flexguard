...
thread_count_mcs, _, mcs = load("mcs.csv")
thread_count_ideal, _, ideal = load("ideal.csv")

thread_count_futex = np.array(thread_count_futex) / 40
thread_count_mcs = np.array(thread_count_mcs) / 40
thread_count_ideal = np.array(thread_count_ideal) / 40
